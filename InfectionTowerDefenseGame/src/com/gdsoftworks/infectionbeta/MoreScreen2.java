...
public class MoreScreen2 extends GLScreen {
	...
	public void present() {
		...
		batcher.beginBatch(Assets.more2);
		batcher.drawSprite(160, 240, 320, 480, Assets.more2Region);
		batcher.endBatch();
